                            ...
                            <div class="col-md-8">
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>{{ $pencatatan->tanggal->format('d/m/Y') }}
                                            ({{ $pencatatan->tanggal->diffForHumans() }})</td>
                                    </tr>
                                    <tr>
                                        <th>Jenis Ikan</th>
                                        <td><span class="badge badge-success badge-lg">{{ $pencatatan->jenis_ikan }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Kolam</th>
                                        <td><span class="badge badge-secondary badge-lg">{{ $pencatatan->kolam }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Jenis Kegiatan</th>
                                        <td><span class="badge badge-info badge-lg">{{ $pencatatan->jenis_kegiatan }}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Keterangan</th>
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>{{ $pencatatan->jumlah_pakan ? number_format($pencatatan->jumlah_pakan, 2) . ' Kg' : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Berat Ikan</th>
                                        <td>{{ $pencatatan->berat_ikan ? number_format($pencatatan->berat_ikan, 2) . ' Kg' : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Jumlah Ikan</th>
                                        <td>{{ $pencatatan->jumlah_ikan ? number_format($pencatatan->jumlah_ikan) . ' Ekor' : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Kondisi Ikan</th>
                                        <td>
                                            @if ($pencatatan->kondisi_ikan)
                                                @if ($pencatatan->kondisi_ikan == 'Sehat')
                                                    <span
                                                        class="badge badge-success">{{ $pencatatan->kondisi_ikan }}</span>
                                                @elseif($pencatatan->kondisi_ikan == 'Sakit')
                                                    <span
                                                        class="badge badge-warning">{{ $pencatatan->kondisi_ikan }}</span>
                                                @else
                                ...
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>{{ $pencatatan->suhu_air ? number_format($pencatatan->suhu_air, 2) . ' °C' : '-' }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>pH Air</th>
                                    ...
                                    <tr>
                                        <th>Oksigen</th>
                                        <td>{{ $pencatatan->oksigen ? number_format($pencatatan->oksigen, 2) . ' mg/L' : '-' }}
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <div class="text-muted small mt-3">
                                    ...
                                    @if ($pencatatan->updated_at != $pencatatan->created_at)
                                        ...
                                        {{ $pencatatan->updated_at->format('d/m/Y H:i') }}
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                @if ($pencatatan->foto)
                                    <div class="text-center">
                                        <img src="{{ asset('storage/' . $pencatatan->foto) }}" alt="Foto Pencatatan"
                                            class="img-fluid img-thumbnail shadow-sm"
                                            style="max-height: 400px; cursor: pointer;"
                                            onclick="window.open(this.src, '_blank')">
                                        <div class="mt-3">
                                            <a href="{{ asset('storage/' . $pencatatan->foto) }}" target="_blank"
                                ...
                                <!-- Action Buttons -->
                                <div class="mt-4">
                                    <a href="{{ route('user.pencatatan.edit', $pencatatan->id) }}"
