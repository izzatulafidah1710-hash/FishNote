...
<div class="row">
        ...
        <div class="card-body">
            ...
            <div class="text-center mb-3">
                <img src="{{ asset('template/img/logofishnote.png') }}"
                     class="img-fluid"
                     style="max-width: 133px; opacity: 0.9;">
            </div>
    ...
    <div class="card shadow-lg border-0 rounded-lg h-100">
        ...
        <div class="card-body">
            ...
            <p class="text-gray-800 mb-4" style="line-height: 1.6;">
                <span class="font-weight-bold text-primary">FishNote</span> dibangun oleh sebuah tim kecil 
                yang memiliki perhatian besar terhadap pengembangan teknologi di bidang budidaya perikanan. 
                Kami percaya bahwa proses pencatatan, pemantauan, hingga promosi hasil panen dapat menjadi 
                jauh lebih mudah dan efisien melalui pendekatan digital yang sederhana namun kuat. 
                kami menciptakan solusi yang tidak hanya fungsional,tetapi juga nyaman digunakan peternak.
            </p>

            <!-- TEAM MEMBER -->
            <div class="d-flex align-items-center mb-4">
                <img src="{{ asset ('template/img/aidil.jpg') }}"
                     class="rounded-circle shadow-sm"
                     style="width: 60px; height: 60px; object-fit: cover;">

                <div class="ml-3">
                    <h6 class="font-weight-bold text-primary mb-0">Aidil Ardiansyah</h6>
                    <small class="text-muted">Front-End & System Developer</small>
                </div>
            </div>

            <div class="d-flex align-items-center mb-4">
                <img src="/images/team/izzatul.jpg"
                     class="rounded-circle shadow-sm"
                     style="width: 60px; height: 60px; object-fit: cover;">

                <div class="ml-3">
                    <h6 class="font-weight-bold text-success mb-0">Izzatul Afidah</h6>
                    <small class="text-muted">Data Analyst & Content Support</small>
                </div>
            </div>

            <div class="d-flex align-items-center mb-3">
                <img src="/images/team/yuniarti.jpg"
                     class="rounded-circle shadow-sm"
                     style="width: 60px; height: 60px; object-fit: cover;">

                <div class="ml-3">
                    <h6 class="font-weight-bold text-info mb-0">Yuniarti Mulansari</h6>
                    <small class="text-muted">UI/UX & Documentation Specialist</small>
                </div>
            </div>
